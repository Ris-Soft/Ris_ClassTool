...
onMounted(() => {
  windowData.value = windowManager.createSuperimposedWindow()
  console.log('超级置顶窗口数据:', windowData.value)
})
...
<template>
  <div class="superimposed-window">
    <!-- 自定义标题栏 -->
    <div class="title-bar">
      <div class="window-title">超级置顶窗口</div>
